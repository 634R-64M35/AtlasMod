...
namespace AtlasMod.Common
{
    ...
    {
        internal static readonly List<Trail> AdditiveTrails = new();
        internal static readonly List<Trail> AlphaBlendTrails = new();
        ...
        public override void Load()
        {
            ...
            BasicPrimitiveEffect = ModContent.Request<Effect>(AtlasMod.AssetPath + "Effects/Primitive");
    ...
    public abstract class Trail
    {
        ...
        public Trail(Entity target, int length, Asset<Effect> effect = null, bool additive = false)
        {
            ...
            _effect.Value.Parameters["texture0"].SetValue(TextureAssets.MagicPixel.Value);
        ...
        public void Kill()
        {
            ...
            if (Additive) PrimitiveTrailSystem.AdditiveTrails.Remove(this);
            else PrimitiveTrailSystem.AlphaBlendTrails.Remove(this);
        }
